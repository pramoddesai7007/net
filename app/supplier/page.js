  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-8">
        ...
        <div className="mb-4">
          <label htmlFor="emailId" className="block text-sm font-medium text-gray-600">
            Email ID:
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label htmlFor="gstNumber" className="block text-sm font-medium text-gray-600">
            GST Number:
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label htmlFor="openingBalance" className="block text-sm font-medium text-gray-600">
            Opening Balance:
          </label>
          <input
            type="text"
      ...
      {isSuccessPopupOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* Modal Content */}
          <div className="relative z-50 bg-white p-6 rounded-md shadow-lg">
            <h2 className="text-2xl font-bold mb-4">Vendor Added Successfully!</h2>
