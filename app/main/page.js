...
// // import { faSearch, faEye, faHouse, faPenToSquare, faPlus, faTrash } from '@fortawesome/free-solid-svg-icons';
...
// //     const [isViewMainCategoryModalOpen, setIsViewMainCategoryModalOpen] = useState(false);
...
// //             // If there's a new image, append it to the FormData
// //             if (newMenuImage) {
...
// //     };
// //     const menusPerPage = 5; // Change this to set the number of menus per page
...
// //             // Update the menus state with the new menu
// //             setMenus((prevMenus) =>
// //                 prevMenus.map((menu) => (menu._id === updatedMainCategory._id ? updatedMainCategory : menu))
// //             );
...
// //         };
// //         fetchMenus();
// //     }, [searchInput, menus]);  // Include 'menus' in the dependency array if it's being used
...
// //                 <td className="p-1 border text-center text-orange-900">
// //                     {pageNumber * menusPerPage + index + 1}
// //                 </td>
// //                 <td className="p-1 border text-center text-orange-900">{menu.name}</td>
...
// //                     <button
// //                         className="text-white mr-3 hover:bg-green-600 focus:outline-none font-sans font-medium border p-1 bg-green-600 rounded-md px-4 text-sm"
// //                         onClick={() => handleEdit(menu)}
// //                     >
// //                         <FontAwesomeIcon icon={faPenToSquare} className="cursor-pointer" /> Edit
// //                     </button>
// //                     <button
// //                         className="text-white  mr-3 hover:bg-green-800 font-sans focus:outline-none font-medium border p-1 bg-red-700 rounded-md px-4 text-sm"
// //                         onClick={() => handleDelete(menu)}
// //                     >
// //                         <FontAwesomeIcon icon={faTrash} className="cursor-pointer" /> Delete
// //                     </button>
// //                 </td>
// //             </tr>
// //         ));
...
// //         <>
// //             <Navbar />
// //             <div className="container text-lg font-sans font-semibold mx-auto p-5 w-full overflow-x-auto border-gray-300 ">
// //                 <h1>Menu List</h1>
// //             </div>

// //             <div className="flex justify-end mb-1 -mt-16 container mx-auto p-5 w-full overflow-x-auto border-gray-300 border-2 shadow-md">
...
// //                     <h1 className="text-md font-semibold font-sans mb-2 -mt-4">Menu Category</h1>
// //                     <div className="flex justify-end mb-3 -mt-8">

// //                         <div className="relative mx-auto text-gray-600">

// //                             <input
// //                                 className="border-2 border-gray-300 mr-4 bg-white h-9 px-5 pr-16 rounded-md text-sm focus:outline-none mt-3"
// //                                 id="searchInput"
// //                                 type="text"
// //                                 name="searchInput"
// //                                 placeholder="Search"
...
// //                                 <FontAwesomeIcon icon={faSearch} className="text-gray-700 mr-3" />
// //                             </button>
// //                         </div>

// //                         <div className="flex justify-end mb-3 -mt-8">
// //                             <button
// //                                 className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md text-sm mt-11"
...
// //                     <thead className='text-sm bg-orange-600 text-white'>
// //                         <tr>
...
// //                         Showing{' '}
// //                         <span className="font-semibold text-gray-900 dark:text-white">{pageNumber * menusPerPage + 1}</span> to{' '}
// //                         <span className="font-semibold text-gray-900 dark:text-white">
// //                             {Math.min((pageNumber + 1) * menusPerPage, menus.length)}
// //                         </span>{' '}
// //                         of{' '}
// //                         <span className="font-semibold text-gray-900 dark:text-white">{menus.length}</span> Menus
// //                     </span>
...
// //                             <Image src={completeImageUrl} alt="Preview" width={500} height={500} />
// //                             <button
// //                                 type="button"
...
// //                         ></button>
// //                         <div className="p-1 text-center">
// //                             <h3 className="mb-5 text-lg font-semibold text-gray-800 dark:text-gray-400">Edit Menu</h3>

// //                             <div className="mb-4">
// //                                 <label htmlFor="editMenuName" className="block text-sm font-medium text-gray-700 dark:text-gray-400">
// //                                     Name
// //                                 </label>
// //                                 <input
// //                                     type="text"
...
// //                             <div className="mb-4">
// //                                 <label htmlFor="editMenuImage" className="block text-sm font-medium text-gray-700 dark:text-gray-400">
// //                                     Image
// //                                 </label>
// //                                 <input
// //                                     type="file"
...
// //                         ></button>
// //                         <div className="p-1 text-center">
// //                             <h3 className="mb-5 text-lg font-semibold text-gray-800 dark:text-gray-400">Add New Menu</h3>

// //                             <div className="mb-4">
// //                                 <label htmlFor="newMenuName" className="block text-sm font-medium text-gray-700 dark:text-gray-400">
// //                                     Name
// //                                 </label>
// //                                 <input
// //                                     type="text"
...
// //                             <div className="mb-4">
// //                                 <label htmlFor="newMenuImage" className="block text-sm font-medium text-gray-700 dark:text-gray-400">
// //                                     Image
// //                                 </label>
// //                                 <input
// //                                     type="file"
...
// //                         ></button>
// //                         <div className="p-1 text-center">
// //                             <h3 className="mb-5 text-lg font-semibold text-gray-800 dark:text-gray-400">Delete Menu</h3>

// //                             <p className="mb-5 text-sm text-gray-700 dark:text-gray-400">
// //                                 Are you sure you want to delete the menu <strong>{editedMenu.name}</strong>?
// //                             </p>

// //                             <button
// //                                 type="button"
// //                                 className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg mr-2"
// //                                 onClick={() => handleDelete(editedMenu)}
// //                             >
// //                                 Delete
// //                             </button>
// //                             <button
...
// //                         ></button>
// //                         <div className="p-1 text-center">
// //                             <h3 className="mb-5 text-lg font-semibold text-gray-800 dark:text-gray-400">View Main Category</h3>
// //                             <div className="p-1 text-center">
...
//       <div className="container mx-auto p-2 w-full overflow-x-auto -mt-3 border-gray-300 border-2 shadow-md ">
...
//               <button
//                 type="button"
//                 className="border border-gray-400 hover:bg-gray-300 text-white font-bold py-2 px-4 rounded-full mr-2"
//                 onClick={() => handleDelete(editedMenu)}
//               >
//                 Delete
//               </button>
